...
function StudentLife() {
  ...
  return (
    <>
      <SEO
        title="Student Life | Rose Bud Academy | Activities & Events"
        description="Explore student activities, cultural programs, celebrations, educational trips, sports, and environmental awareness programs at Rose Bud Academy, Boginadi, Lakhimpur, Assam."
      />
